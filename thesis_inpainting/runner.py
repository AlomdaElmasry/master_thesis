...
class ThesisInpaintingRunner(thesis.runner.ThesisRunner):
    ...
    def compute_loss(utils_losses, y_target, v_target, y_hat, y_hat_comp, v_map):
        ...
        loss_nh = utils_losses.masked_l1(y_hat, target_img, nh_mask)
        loss_vh = utils_losses.masked_l1(y_hat, target_img, vh_mask)
        loss_nvh = utils_losses.masked_l1(y_hat, target_img, nvh_mask)
